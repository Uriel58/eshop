...
public class Product {
	//product有prod_num,prod_name,prod_type(大類),prod_line(大類的細分),prod_price,prod_info(產品資訊),prod_keywords,prod_barcode(條碼）,created_time,prod_tags,prod_images,prod_stock_qty
    @Id
    ...
    public Product(String prodName, String prodType, String prodLine, BigDecimal prodPrice,
                   String prodInfo, String prodKeywords, String prodBarcode, LocalDateTime createdTime,
